...
import com.videocaht.recorder.facetime.videocall.screenrecorder.R;

public class buy_panel extends Activity
{
    com.videocaht.recorder.facetime.videocall.screenrecorder.util.IabHelper mHelper;
    ...
    static final String forever = "removeads_lifetime";
      String current="";
    com.videocaht.recorder.facetime.videocall.screenrecorder.util.IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener;
    com.videocaht.recorder.facetime.videocall.screenrecorder.util.IabHelper.OnConsumeFinishedListener mConsumeFinishedListener;
    private boolean buy;
    ...
    public void buyClick_day(View view)
    {
        ...
        } catch (com.videocaht.recorder.facetime.videocall.screenrecorder.util.IabHelper.IabAsyncInProgressException e) {
            e.printStackTrace();
        }
    }
    ...
    public void In_app()
    {
        ...
        mHelper = new com.videocaht.recorder.facetime.videocall.screenrecorder.util.IabHelper(this, base64EncodedPublicKey);
        mHelper.startSetup(new com.videocaht.recorder.facetime.videocall.screenrecorder.util.IabHelper.OnIabSetupFinishedListener()
        {
            public void onIabSetupFinished(com.videocaht.recorder.facetime.videocall.screenrecorder.util.IabResult result)
            {
                if (!result.isSuccess()) {
        ...
        mPurchaseFinishedListener = new com.videocaht.recorder.facetime.videocall.screenrecorder.util.IabHelper.OnIabPurchaseFinishedListener() {
            public void onIabPurchaseFinished(com.videocaht.recorder.facetime.videocall.screenrecorder.util.IabResult result,
                                              com.videocaht.recorder.facetime.videocall.screenrecorder.util.Purchase purchase) {
                if (result.isFailure())
                {
        ...
        mConsumeFinishedListener =
                new com.videocaht.recorder.facetime.videocall.screenrecorder.util.IabHelper.OnConsumeFinishedListener()
                {
                    public void onConsumeFinished(com.videocaht.recorder.facetime.videocall.screenrecorder.util.Purchase purchase,
                                                  com.videocaht.recorder.facetime.videocall.screenrecorder.util.IabResult result) {
    ...
    com.videocaht.recorder.facetime.videocall.screenrecorder.util.IabHelper.QueryInventoryFinishedListener mReceivedInventoryListener
            = new com.videocaht.recorder.facetime.videocall.screenrecorder.util.IabHelper.QueryInventoryFinishedListener() {
        public void onQueryInventoryFinished(com.videocaht.recorder.facetime.videocall.screenrecorder.util.IabResult result,
                                             com.videocaht.recorder.facetime.videocall.screenrecorder.util.Inventory inventory)
        {
